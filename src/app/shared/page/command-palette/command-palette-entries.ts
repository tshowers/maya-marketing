...
export const COMMAND_PALETTE_ENTRIES: CommandPaletteEntry[] = [
  // --- Maya (this app) ----------------------------------------------------
  { id: 'maya-home', label: 'Maya', group: 'Maya', path: '/', keywords: ['maya', 'marketing director', 'chat', 'home'] },
  { id: 'maya-status', label: 'Status', group: 'Maya', path: '/marketing-employee', keywords: ['status', 'marketing status', 'employee status'] },
  { id: 'maya-plan', label: 'Plan', group: 'Maya', path: '/marketing-employee/plan', keywords: ['plan', 'marketing plan', 'plan board'] },
